...
const Contact = () => {
    ...
    return (
        <>
            <Head>
                <title>Контакт - {siteMetadata.author}</title>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3">
                            ...
                            <div className="relative px-6 py-10 overflow-hidden rounded-lg bg-gradient-to-b from-accent-500 to-accent-600 sm:px-10 xl:p-12">
                                ...
                                <p className="max-w-3xl mt-6 text-base text-white dark:text-slate-800">
                                    Пожалуйста, свяжитесь со мной по любым вопросам или комментариям, которые у вас могут возникнуть. Вы также можете запланировать услугу через форму ниже.
                                </p>
